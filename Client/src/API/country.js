...
const getCountriesAPI = async (id = null) => {
    let resolved = {
        data: null,
        error: null
    }
    try {
        const res = await axios({
            url: id == null ? `country/` : `country/?id=${id}`,
            method: "GET",
            headers: {
...
const AddCountryAPI = async (data) => {
    let resolved = {
        data: null,
        error: null
    }
...
export { getCountriesAPI, AddCountryAPI, EditCountryAPI, deleteCountriesAPI }